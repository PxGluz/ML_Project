...
mnb_Dansk = KNeighborsClassifier(n_neighbors=20)
...
mnb_Deutsch = KNeighborsClassifier(n_neighbors=20)
...
mnb_Espanol = KNeighborsClassifier(n_neighbors=20)
...
mnb_Italiano = KNeighborsClassifier(n_neighbors=20)
...
mnb_Nederlands = KNeighborsClassifier(n_neighbors=20)
