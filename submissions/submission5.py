...
mnb_language = MultinomialNB(alpha=0.8)
mnb_language.fit(BOW_ALL[1], BOW_ALL[2])

mnb_Dansk = MultinomialNB(alpha=0.5)
...
mnb_Deutsch = MultinomialNB(alpha=0.5)
...
mnb_Espanol = MultinomialNB(alpha=0.5)
...
mnb_Italiano = MultinomialNB(alpha=0.5)
...
mnb_Nederlands = MultinomialNB(alpha=0.5)
